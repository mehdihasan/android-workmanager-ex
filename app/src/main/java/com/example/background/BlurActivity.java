    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel.getOutputWorkInfo().observe(this, listOfWorkInfos -> {
            ...
            if (!finished) {
                ...
                showWorkFinished();
                Data outputData = workInfo.getOutputData();// TODO get the output Data from the workInfo
                String outputImageUri = outputData.getString(Constants.KEY_IMAGE_URI);// TODO get the Uri from the Data using the
